...
import com.abbink.sws2.persistence.generated.jooq.Indexes;
...
public class FlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {
    ...
    private static final long serialVersionUID = 1018027632;
     ...
     */
    public final TableField<FlywaySchemaHistoryRecord, Timestamp> INSTALLED_ON = createField("installed_on", org.jooq.impl.SQLDataType.TIMESTAMP.precision(6).nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
